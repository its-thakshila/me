...
export const Home = () => {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText('bandarahbct@gmail.com');
    setCopied(true);
        ...
        <div style={isMobile ? {
          ...
          <div style={{ width: 1440, height: 1024, position: 'relative', transformStyle: 'preserve-3d' }}>
            ...
            {PROJECTS_DATA.map((p) => (
              <Card key={p.id} isMobile={isMobile} isFocused={isMobile && activeSection.id === p.id} onHoverChange={onCardHover} style={{ width: 450, height: 'max-content', left: p.left, top: p.top, padding: '17px 21px' }}>
                ...
                <div className="card-project">
                  ...
                  <SweepText dim text={p.desc} style={{ color: 'rgba(111,111,111,1)', fontSize: 17, fontFamily: '"Outfit",sans-serif', fontWeight: 400, lineHeight: 1.4, marginTop: 8 }} />
                </div>
              </Card>
            ))}
            ...
            <div style={{
              ...
              <a href="https://github.com/its-thakshila" target="_blank" rel="noreferrer" title="GitHub" className="social-link">
              ...
              <a href="https://www.linkedin.com/in/its-thakshila" target="_blank" rel="noreferrer" title="LinkedIn" className="social-link">
              ...
              <a href="https://web.facebook.com/its.thakshila" target="_blank" rel="noreferrer" title="Facebook" className="social-link">
              ...
              <a href="https://www.instagram.com/its.thakshila" target="_blank" rel="noreferrer" title="Instagram" className="social-link">
              ...
              <button onClick={handleCopy} className="social-link" style={{ background: 'none', border: 'none', padding: 0, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 8 }}>
                <span style={{ fontSize: 22, fontFamily: '"Outfit",sans-serif', fontWeight: 500, color: 'inherit', width: 195, textAlign: 'right', display: 'inline-block' }}>{copied ? 'Email Copied!' : 'Connect via Email'}</span>
