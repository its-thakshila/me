        ...
        <div style={isMobile ? {
          ...
          <div style={{ width: 1440, height: 1024, position: 'relative', transformStyle: 'preserve-3d' }}>
            ...
            <div style={{
              ...
              <a href="https://github.com/thakshilabandara" target="_blank" rel="noreferrer" title="GitHub" className="social-link">
              ...
              <a href="https://linkedin.com/in/thakshilabandara" target="_blank" rel="noreferrer" title="LinkedIn" className="social-link">
              ...
              <a href="https://facebook.com/thakshilabandara" target="_blank" rel="noreferrer" title="Facebook" className="social-link">
              ...
              <a href="https://instagram.com/thakshilabandara" target="_blank" rel="noreferrer" title="Instagram" className="social-link">
